...
var _workbox$strategies = workbox.strategies,
  CacheFirst = _workbox$strategies.CacheFirst,
  NetworkFirst = _workbox$strategies.NetworkFirst;
...
registerRoute(function (_ref2) {
  var request = _ref2.request,
    url = _ref2.url;
  return request.destination === "document" || request.destination === "";
}, new NetworkFirst({
  cacheName: "documents"
...
var warmStrategyCache = workbox.recipes.warmStrategyCache;
var setCatchHandler = workbox.routing.setCatchHandler;
var strategy = new CacheFirst();
var urls = ["/offline.html"]; // Warm the runtime cache with a list of asset URLs
warmStrategyCache({
  urls: urls,
  strategy: strategy
}); // Trigger a 'catch' handler when any of the other routes fail to generate a response
setCatchHandler( /*#__PURE__*/function () {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          ...
          _context.next = _context.t0 === "document" ? 4 : 5;
          break;
        case 4:
          return _context.abrupt("return", strategy.handle({
            event: event,
            request: urls[0]
          }));
        case 5:
